...
<div class="cuar-needs-attention">
	...
	<p><?php printf( __('Some template files you have overridden have been modified in the current version of Customer Area. You have the list of these files below, but you can also '
...
<?php if ( version_compare( $this->plugin->get_version(), '4.4.0', '<=' ) ) : ?>	
	...
	<p><em><?php _e('Since Customer Area 4.4.0, we are providing a way to make sure your template files are always up-to-date. For you, this is a great way to know when template '
