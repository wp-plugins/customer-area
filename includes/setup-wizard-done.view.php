...
<div class="wrap cuar-wizard">
	...
	<div class="cuar-main">
		...
		<h1><?php _e( "What's next?", 'cuar'); ?></h1>
		
		<p><?php printf( __( 
					'You should have a look at the <a href="%1$s" target="_blank">plugin settings</a> to adjust a few things.', 'cuar' ),
				admin_url( 'admin.php?page=' .  CUAR_Settings::$OPTIONS_PAGE_SLUG )
			); ?></p>
		
		<p><?php _e( "You can also get notified when we've got something exciting to say (plugin updates, news, etc.). Simply "
		...
		<h1><?php _e( "Improving your Customer Area", 'cuar'); ?></h1>
